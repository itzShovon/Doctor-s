...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Data/CSS/FooterStyle.css">
</head>

<body>
    <div class="footerX" id="footerX">
        <div class="footer" id="footer">
            ...
            <hr>
            <p>Copyright &copy; Shovon</p>
            <div class="footer_developer" id="footer_developer">
                <div class="person" id="person">
                    <div class="person_left">
                        <img class="person_img" src="Data/Images/Footer/Shovon.jpg" alt="Shovon" height="42" width="42">
                        <h3>Zahidul Islam</h3>
                    </div>
                    <div class="person_right">
                        ...
                        <a href="https://github.com/itzShovon" title="Connect to GitHub" target="_blank"><img src="Data/Images/Footer/github-icon.png" alt="Connect to Github" height="42" width="42"></a>
                    </div>
                </div>
            </div>
        </div>
